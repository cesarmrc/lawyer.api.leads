...
public class LeadCommandRepository : CommandRepository<domain.Lead, LeadEntity>, ILeadCommandRepository
{
    private readonly IMapper _mapper;

    public LeadCommandRepository(LawyersContext dbContext, IMapper mapper) : base(dbContext, mapper)
    {
        _mapper = mapper;
    }
}
